            ...
            <li class="submenu">
              ...
              <ul class="collapse menu-dropdown" id="sidebarApp">
                ...
                <li>
                  <router-link
                    :class="
                      currentPath == '/app-settings/printer-settings' ? 'active' : 'notactive'
                    "
                    to="/app-settings/printer-settings"
                    >Printer</router-link
                  >
                </li>
                <li>
            ...
            <li class="submenu">
              ...
              <ul class="collapse menu-dropdown" id="sidebarFinancial">
                <li>
                  <router-link
                    :class="
                      currentPath == '/financial-settings/payment-gateway-settings'
                        ? 'active'
                        : 'notactive'
                    "
                    to="/financial-settings/payment-gateway-settings"
                ...
                <li>
                  <router-link
                    :class="
                      currentPath == '/financial-settings/bank-settings-grid'
                        ? 'active'
                        : 'notactive'
                    "
                    to="/financial-settings/bank-settings-grid"
  ...
  computed: {
    ...
    isAppMenu() {
      return (
        ...
        this.$route.name == "/app-settings/printer-settings" ||
    ...
    isFinancialMenu() {
      return (
        this.$route.name == "/financial-settings/payment-gateway-settings" ||
        this.$route.name == "/financial-settings/bank-settings-grid" ||
