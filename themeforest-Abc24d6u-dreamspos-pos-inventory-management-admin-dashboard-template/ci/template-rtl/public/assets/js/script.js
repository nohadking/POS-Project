							...
							'<div class="layout-wrap">' +								
								'<div class="d-flex align-items-center">' +
									'<div class="status-toggle d-flex align-items-center me-2">' +
										...
										'<label for="1" class="checktoggle"><a  href="dashboard"class="layout-link">checkbox</a> </label>' + 
									'</div>' +
							...
							'<div class="layout-wrap">' +								
								'<div class="d-flex align-items-center">' +
									'<div class="status-toggle d-flex align-items-center me-2">' +
										...
										'<label for="1" class="checktoggle"><a  href="../template-rtl/dashboard"class="layout-link">checkbox</a> </label>' + 
									'</div>' +
