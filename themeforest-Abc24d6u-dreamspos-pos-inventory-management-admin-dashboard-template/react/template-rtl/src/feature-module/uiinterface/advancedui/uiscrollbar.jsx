          ...
          <div className="col-md-6 d-flex">
            <div className="card"  style={{ width: "100%" }}>
              ...
              <div className="card-body">
                <div className="scroll-bar-wrap" style={{ direction: "rtl" }}>
          ...
          <div className="col-md-6 d-flex">
            <div className="card" style={{ width: "100%" }}>
              ...
              <div className="card-body"  >
                ...
                <Scrollbars className="style-scrollbar" style={{ width: "100%", height: "100%" }}>
          ...
          <div className="col-md-6 d-flex">
            <div className="card" style={{ width: "100%" }}>
              ...
              <div className="card-body" style={{ height: "300px" }}>
                <Scrollbars className="style-scrollbar" style={{ width: "100%", height: "80%" }}>
