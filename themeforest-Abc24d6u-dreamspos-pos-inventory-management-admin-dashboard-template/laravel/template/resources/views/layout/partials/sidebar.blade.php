            ...
            <ul>
                <li class="submenu-open">
                    ...
                    <ul>
                        ...
                        <li class="submenu">
                            <a href="javascript:void(0);"
                                class="{{ Request::is('chat', 'social-feed', 'kanban-view', 'invoices', 'file-manager', 'file-archived','file-document','file-favourites','file-manager-seleted','file-recent','file-shared','notes', 'todo', 'email', 'calendar', 'call-history', 'audio-call', 'video-call','file-manager-deleted') ? 'active subdrop' : '' }} "><i
                        ...
                        <li class="submenu">
                            ...
                            <ul>
                                <li class="submenu submenu-two">
                                    <a href="javascript:void(0);"
                                        class="{{ Request::is('form-basic-inputs', 'form-pickers', 'form-checkbox-radios', 'form-input-groups', 'form-grid-gutters', 'form-select', 'form-mask', 'form-fileupload') ? 'active subdrop' : '' }}">Form
