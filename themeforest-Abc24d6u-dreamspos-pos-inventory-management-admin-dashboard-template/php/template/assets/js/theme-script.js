...
setTimeout(function () {
    $('.main-wrapper').append('<div class="sidebar-settings nav-toggle" id="layoutDiv">' +
        ...
        '<a href="../template/index.php"><img src="assets/img/theme/theme-img-01.jpg" alt=""></a>' +
        ...
        '<a href="../template-rtl/index.php" target="_blank"><img src="assets/img/theme/theme-img-03.jpg" alt=""></a>' +
